...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/css/block-lists.css">
	<link rel="stylesheet" type="text/css" href="/css/simple-lists.css">
	...
	<link rel="stylesheet" type="text/css" href="/css/960.gs.fluid.css">
	<!-- Favicon -->
...
<div class="container_12">
    ...
    <div class="grid_7" id="facture"></div>
</div>
